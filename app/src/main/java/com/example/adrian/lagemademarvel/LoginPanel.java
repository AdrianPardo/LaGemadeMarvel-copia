...
public class LoginPanel extends AppCompatActivity {
    ...
    public void Login_User(View view) {
        if(emailET.getText().toString().equals("") || passwordET.getText().toString().equals("")) {
            Toast.makeText(LoginPanel.this, R.string.empty_login_field, Toast.LENGTH_SHORT).show();
        }else{
            changebutton();
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                HideLoadingAnimation();
                                Toast.makeText(LoginPanel.this, R.string.login_failed_message, Toast.LENGTH_SHORT).show();
                                changebutton();
                            }
                        }
                    });
